...
export const TOOLS: Record<string, ToolSpec> = {
  ...
  algo: {
    ...
    schema: {
      type: 'object',
      properties: {
        overall_score: { type: 'integer', minimum: 0, maximum: 100, description: 'Predicted algorithm performance, 0–100.' },
      ...
      required: ['overall_score', 'why', 'change_this', 'rewritten_hook'],
    },
    build: (input, o) => ({
      system: `You are a ${o.platform ?? 'Instagram'} algorithm coach. Be direct, specific, and encouraging — like a sharp creative director. Always return exactly three why-bullets, one concrete change, and one rewritten hook.`,
